...
- Implementation on UR3e and UR10e:
![](https://github.com/trungtran22/vive_ur/blob/main/docs/Video%20Project.gif)
![](https://github.com/trungtran22/vive_ur/blob/main/docs/real_robot_impl_2.gif)
### ROS Architecture and Communication:
![](https://github.com/trungtran22/vive_ur/blob/main/docs/ros_vr.png)
### Method:
...
```
### Instruction of installation VIVE SDK from [vive_ros](https://github.com/robosavvy/vive_ros) | ROS 1 Noetic:
```
  cd ~
  mkdir libraries
  cd libraries
